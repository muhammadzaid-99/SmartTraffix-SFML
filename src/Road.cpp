...
void Road::addVehicle(sf::Text numberPlate, VehicleType vt) {
    Vehicle *vehicle;
    ...
    if (vt == VehicleType::HTV) {
        ...
        vehicle = new HeavyVehicle(numberPlate, slowLaneVehiclesInitPos, direction, 40.f, 11.1111f * 8, sf::Color(64, 0, static_cast<sf::Uint8>(pg.getRandomProb(128, 255))));
    ...
    if (vt == VehicleType::LTV) {
        ...
        vehicle = new LightVehicle(numberPlate, fastLaneVehiclesInitPos, direction, 40.f, 16.6667f * 8, sf::Color(0, static_cast<sf::Uint8>(pg.getRandomProb(128, 255)), 64));
        ...
        vehicle = new EmergencyVehicle(numberPlate, fastLaneVehiclesInitPos, direction, 40.f, 22.2222f * 8, sf::Color(static_cast<sf::Uint8>(pg.getRandomProb(128, 255)), 64, 0));
        // if (fastLaneVehicles.size())
        //     vehicle->setSpeed(pg.getRandomProb(40.f, std::min(vehicle->getMaxSpeed(), fastLaneVehicles.front()->getSpeed())));
        // else
        vehicle->setSpeed(pg.getRandomProb(40.f, vehicle->getMaxSpeed()));
